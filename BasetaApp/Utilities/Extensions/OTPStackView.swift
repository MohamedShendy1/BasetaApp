...
class OTPStackView: UIStackView {
    ...
    //Colors
    let inactiveFieldBorderColor = #colorLiteral(red: 0.6000000238, green: 0.6000000238, blue: 0.6000000238, alpha: 1)
    let textBackgroundColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
    let activeFieldBorderColor = #colorLiteral(red: 0.3207446337, green: 0.6371595263, blue: 0.8308730125, alpha: 1)
    ...
    private final func setupTextField(_ textField: OTPTextField){
        ...
        textField.font = UIFont(name: "Kefa", size: 25)
